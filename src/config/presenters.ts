...
export const PresenterProfile = z.object({
  ...
  /** HeyGen identity. CLI transport: look_id (ephemeral, resolved from group_id at runtime) or group_id. Legacy REST transport: avatar_id / talking_photo_id. */
  heygen: z.object({ look_id: z.string().optional(), group_id: z.string().optional(), avatar_id: z.string().optional(), talking_photo_id: z.string().optional() }).default({}),
});
